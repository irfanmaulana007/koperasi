...
@section('link-add','suku-bunga/create') <!-- URL Create -->
@section('nav','master') <!-- ID Current Nav -->
@section('subnav','master-sukubunga') <!-- ID Current Subnav -->
@section('title','Master Suku Bunga')
                ...
                <td class="hidden-print">
                    <div class="btn-group m-r-5 m-b-5">
                        ...
                        <ul class="dropdown-menu dropdown-action pull-right">
                            <li>
                                <a class="text-center" href="{{ URL::to('master/suku-bunga/'.$value->id.'/edit') }}">Edit</a>
                            </li>
                            <li>
                                <a>
                                    {{ Form::open(array('url' => 'master/suku-bunga/' . $value->id, 'class' => 'delete')) }}
                                        {{ csrf_field() }}
